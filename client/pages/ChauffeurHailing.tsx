          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-300 max-w-2xl mb-8">
                Premium rides on demand — professional chauffeurs, swift
                pickups, and an experience designed for people who value time
                and comfort.
              </p>
                ...
                <Card className="p-8 bg-black/50 border-gray-800 shadow-2xl">
                  <div className="flex gap-4 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Uniformed, professional, and familiar with the fastest
                        routes in the city.
                      </p>
                      <div className="mt-4 flex gap-3">
                        <Button
                          size="sm"
                          variant="outline"
                          className="border-corporate-gold text-corporate-gold"
                        >
                          How it works
                        </Button>
                        <Button
                          size="sm"
                          className="bg-corporate-gold text-black"
                        >
                          View Fleet
                        </Button>
                      </div>
        ...
        <div className="container">
          ...
          >
            <h2 className="text-3xl font-bold mb-4">
              Why riders prefer Chauffeur Hailing
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Service built for professionals who demand reliability, comfort
              and discretion.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {[
              {
                icon: <Clock className="w-6 h-6 text-corporate-gold" />,
                title: "Convenience",
                desc: "Rides in minutes — book instantly.",
              },
              {
                icon: <Car className="w-6 h-6 text-corporate-gold" />,
                title: "Comfort",
                desc: "Luxury vehicles, immaculate interiors.",
              },
              {
                icon: <CheckCircle className="w-6 h-6 text-corporate-gold" />,
                title: "Quality",
                desc: "High service standards and checks.",
              },
              {
                icon: <MapPin className="w-6 h-6 text-corporate-gold" />,
                title: "Your Schedule",
                desc: "On-demand or pre-booked pickups.",
              },
              {
                icon: <Users className="w-6 h-6 text-corporate-gold" />,
                title: "Reliability",
                desc: "Punctual chauffeurs and accurate ETAs.",
              },
              {
                ...
                >
                  {[120, 240, 360, 480].map((x, i) => (
                    <motion.circle
                      ...
                      animate={{ opacity: [0.6, 1, 0.6], r: [4, 10, 4] }}
        ...
        <div className="container">
          ...
          >
            ...
            <p className="text-gray-300">
              Where Chauffeur Hailing is currently available.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-900/50 to-black relative overflow-hidden">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl font-bold mb-4">
                Your chauffeur, one tap away
              </h2>
              <p className="text-gray-300 mb-6">
                Download the app to request rides, track chauffeurs in real
                time, and manage bookings with ease.
              </p>
              <div className="flex gap-4">
                <Button
                  variant="outline"
        ...
        <div className="container max-w-3xl">
          ...
          >
            ...
            <p className="text-gray-400">
              Quick answers about Chauffeur Hailing.
            </p>
          </motion.div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {[
              {
                q: "How quickly can I get a chauffeur?",
                a: "In covered cities, you can expect a pickup within minutes for on-demand rides. Exact wait times depend on driver availability.",
              },
              {
                q: "Can I pre-schedule rides?",
                a: "Yes, schedule immediate or future pickups directly in the app to guarantee a chauffeur.",
              },
              {
                q: "What is included in the fare?",
                a: "Fares include the chauffeur, vehicle, taxes and reasonable waiting time. Additional fees may apply for long stops.",
              },
            ].map((f, idx) => (
              <AccordionItem
                key={idx}
