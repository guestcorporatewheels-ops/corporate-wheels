  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center pt-24">
      ...
      <div className="container grid gap-8">
        ...
        >
          <p className="text-sm tracking-widest text-secondary mb-3 uppercase">Premium Chauffeur Service</p>
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Book your ride in seconds — global chauffeur service at your fingertips.
          </p>
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <Button variant="outline-glow" className="px-6 h-12" asChild>
              <a href="#download" className="inline-flex items-center"><Download className="mr-2" /> Download App</a>
            </Button>
          </div>
        </motion.div>
        <div id="booking">
