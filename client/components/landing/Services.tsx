...
const services = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1583391733956-6c78276477e5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
  },
  {
    title: "Hourly Hire",
    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container relative">
        ...
        <div className="mt-12 text-center">
          <a
            href="/services"
            className="inline-flex items-center btn-gradient btn-gradient-animate text-black px-6 py-3 rounded-full font-semibold shadow-lg transition-all"
          >
            View all services
            <svg
              viewBox="0 0 24 24"
