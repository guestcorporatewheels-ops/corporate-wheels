...
const features = [
  {
    ...
    svg: (
      <svg
        viewBox="0 0 24 24"
        className="w-12 h-12 text-corporate-gold mx-auto mb-4"
        fill="none"
        stroke="currentColor"
      >
...
export default function Services() {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <svg className="absolute top-10 left-10 w-32 h-32 text-corporate-gold/10 rotate-45" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        <circle cx="12" cy="12" r="10" strokeWidth="1.5" />
      </svg>
      <svg className="absolute bottom-20 right-10 w-40 h-40 text-corporate-gold/10 animate-spin-slow" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        <path d="M12 2v4m0 12v4m10-10h-4M6 12H2m15.364-6.364l-2.828 2.828M8.464 15.536l-2.828 2.828M15.536 15.536l2.828 2.828M8.464 8.464L5.636 5.636" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg ">
              Premium experiences tailored for business and leisure travelers who
              expect excellence.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((f) => (
            ...
            >
              {/* Glow Effect */}
              <motion.div
                className="absolute inset-0 bg-gradient-to-tr from-corporate-gold/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"
              />
